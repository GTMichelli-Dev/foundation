...
Public Class Outbound_Ticket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Basic_Weigh.Outbound_Ticket.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOutbound_Ticket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Outbound_Ticket = New Outbound_Ticket()
        rpt.Site = Me.Site
        Return rpt
    End Function
