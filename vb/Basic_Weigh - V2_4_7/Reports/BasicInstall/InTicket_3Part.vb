...
Public Class InTicket_3Part
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Basic_Weigh.InTicket_3Part.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInTicket_3Part
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InTicket_3Part = New InTicket_3Part()
        rpt.Site = Me.Site
        Return rpt
    End Function
