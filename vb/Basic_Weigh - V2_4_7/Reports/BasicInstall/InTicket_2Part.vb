...
Public Class InTicket_2Part
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Basic_Weigh.InTicket_2Part.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInTicket_2Part
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InTicket_2Part = New InTicket_2Part()
        rpt.Site = Me.Site
        Return rpt
    End Function
