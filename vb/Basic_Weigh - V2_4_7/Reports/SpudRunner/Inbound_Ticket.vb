...
Public Class Inbound_Ticket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Basic_Weigh.Inbound_Ticket.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInbound_Ticket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Inbound_Ticket = New Inbound_Ticket()
        rpt.Site = Me.Site
        Return rpt
    End Function
